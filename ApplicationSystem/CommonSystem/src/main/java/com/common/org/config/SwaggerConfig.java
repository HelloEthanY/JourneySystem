...
public class SwaggerConfig {
    ...
    public Docket createApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.course.org"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Journey测试项目 接口文档")
                .description("更多技术内容分享见博客：http:localhost:8082/course")
                .termsOfServiceUrl("https://blog.csdn.net/qq_24871519")
                .version("1.0")
                .licenseUrl("http:localhost:8082/course")
                .build();
    }
}
